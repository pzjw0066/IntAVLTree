...
void InorderTraversal(IntAVLTreeNodeStruct *root, void (*pf)(IntAVLTreeNodeStruct*)); // 对AVL树进行中序遍历，pf是遍历时调用的函数
IntAVLTreeNodeStruct *SearchInIntAVLTree(IntAVLTreeNodeStruct *root, int object);     // 在AVL树中查找值所对应的节点
